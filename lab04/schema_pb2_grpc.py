...
class DatabaseStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PutUser = channel.unary_unary(
                ...
                response_deserializer=schema__pb2.ResponseMessage.FromString,
                )
...
def add_DatabaseServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'PutUser': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=schema__pb2.ResponseMessage.SerializeToString,
            ),
...
class Database(object):
    ...
    def PutUser(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Database/PutUser',
            ...
            schema__pb2.ResponseMessage.FromString,
