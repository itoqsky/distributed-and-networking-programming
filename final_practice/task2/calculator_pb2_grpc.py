...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Add = channel.unary_unary(
                ...
                response_deserializer=calculator__pb2.ResponseMessage.FromString,
                )
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Add': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=calculator__pb2.ResponseMessage.SerializeToString,
            ),
...
class Calculator(object):
    ...
    def Add(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Calculator/Add',
            calculator__pb2.Input.SerializeToString,
            calculator__pb2.ResponseMessage.FromString,
